...
import PersonelModel from "./PersonelModel.json";

export default class Personel extends ShallowComponent {
    ...
    constructor(props) {
        ...
        let store = new Store({
            endPoint: new RemoteEndPoint({
                url:"/resources/personels"
            }),
            idField: Personel.idField,
            autoLoad: true
        });

        this.state = {
            fields: PersonelModel.fields,
            store: store,
            showModal: false,
            item: {},
            propsOfFields: {
    ...
    __onSave(newData, callback) {
        let id = newData[Personel.idField];
