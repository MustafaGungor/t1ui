...
import UcusTuruModel from "./UcusTuruModel.json";

export default class UcusTuru extends ShallowComponent {
    ...
    constructor(props) {
        ...
        let store = new Store({
            endPoint: new RemoteEndPoint({
                url:"/resources/ucusTurus"
            }),
            idField: UcusTuru.idField,
            autoLoad: true
        });

        this.state = {
            fields: UcusTuruModel.fields,
            store: store,
            showModal: false,
            item: {},
            propsOfFields: {
    ...
    render() {
        return (
            <Card header="Uçuş Türü Yönetimi">
                <DataGrid
    ...
    __onSave(newData, callback) {
        let id = newData[UcusTuru.idField];
